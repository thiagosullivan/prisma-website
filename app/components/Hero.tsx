        ...
        <section className="bg-hero-img bg-no-repeat bg-cover py-44">
            <div className="max-w-screen-xl mx-auto pl-36">
                <div className="bg-prisma-gray px-12 py-20 max-w-[720px]">
                    ...
                    <h2 className="text-prisma-blue text-5xl mt-6 font-bold">Nós oferecemos a <span className="text-prisma-orange">melhor</span> <br/> solução para seu o <span className="text-prisma-orange">revestimento</span>.</h2>
