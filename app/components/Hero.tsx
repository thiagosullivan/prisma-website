        ...
        <section className="bg-hero-img bg-no-repeat bg-cover py-44">
            <div className="max-w-screen-xl mx-auto pl-36 max-lg:pl-0">
                <div className="bg-prisma-gray px-12 py-20 max-w-[720px] max-lg:max-w-[480px] max-sm:max-w-[380px] max-lg:block max-lg:m-auto max-lg:px-6 max-lg:py-10 max-lg:text-center">
                    <p className="text-prisma-orange text-sm border-b border-prisma-orange w-max max-lg:text-center max-lg:w-full">Trabalho de qualidade, serviço confiável e equipe qualificada!</p>
                    <h2 className="text-prisma-blue text-5xl mt-6 font-bold max-lg:text-3xl">Nós oferecemos a <span className="text-prisma-orange">melhor</span> <br/> solução para o seu <span className="text-prisma-orange">revestimento</span>.</h2>
