        ...
        <section className="max-w-screen-xl mx-auto px-4 text-prisma-blue mt-10" id="servicos">
            <div>
                <div className="flex flex-col items-center">
                    <h2 className="text-center text-sm text-prisma-orange max-lg:text-2xl">Nossos Serviços</h2>
                    <p className="text-center text-5xl mt-5 max-lg:text-3xl">Serviços que oferecemos <br/> com o selo <span className="text-prisma-orange font-semibold">Prisma</span> de qualidade</p>
                </div>
                <div className="grid grid-cols-3 gap-x-3 gap-y-8 justify-items-center mt-24 max-lg:grid-cols-2 max-sm:grid-cols-1">
